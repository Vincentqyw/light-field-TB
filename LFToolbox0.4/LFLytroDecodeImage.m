...
function [LF, LFMetadata,WhiteImage,CorrectedLensletImage,WhiteImageMetadata, LensletGridModel, DecodeOptions] = ...
    LFLytroDecodeImage( InputFname, DecodeOptions )
...
switch( lower(FileExtension) )
    case 'raw' %---Load raw light field and metadata---
        FNameBase = InputFname(1:end-4);% 文件名
...
[LF, LFWeight, DecodeOptions,CorrectedLensletImage] = LFDecodeLensletImageSimple( LensletImage, WhiteImage, LensletGridModel, DecodeOptions );
LF(:,:,:,:,4) = LFWeight;
